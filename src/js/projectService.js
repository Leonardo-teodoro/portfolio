export default class ProjectService {
  getProjectDescription() {
    const projects = {
      ...
      hotCoffee: {
        description:
          "O HotCoffee é um software que gerencia pedidos em uma cafeteria. Nele, o cliente pode escolher seu pedido, fazer o pagamento e avaliar cada produto. Além disso, o proprietário pode ver relatórios sobre quais vendedores se destacaram, quais produtos foram mais vendidos e emitir nota fiscal.",
        techs: [
          {
            name: "HTML",
            pros: [
      ...
      iDrinks: {
        description:
          "O iDrinks é um e-commerce de bebidas. Os clientes deste e-commerce podem fazer os seus pedidos, informando o local de entrega e a forma de pagamento.",
        techs: [
          {
            name: "HTML",
            pros: [
